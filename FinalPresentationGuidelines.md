...
## Before the Final
- Collect screencast(s) of you running your project(s)
  - [OBS](https://obsproject.com/) is recommended
  - You can also use VuJa in canvas
- Generate any diagrams to describe your project
- Combine them into a demo reel between 1:30 and 2 minutes w/o audio
- Upload to YouTube or Vuja
- Get a public link to submit
  - If you use VuJa, you need to make the link pubic in settings
